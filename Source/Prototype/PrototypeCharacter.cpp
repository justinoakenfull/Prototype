...
APrototypeCharacter::APrototypeCharacter()
{
	...
	AbilitySystemComponent = CreateDefaultSubobject<UPWAbilitySystemComponent>(TEXT("AbilitySystemComp"));
...
class UAbilitySystemComponent* APrototypeCharacter::GetAbilitySystemComponent() const
{
...
void APrototypeCharacter::GiveAbilities()
{
	if (HasAuthority() && AbilitySystemComponent)
	{
		for (TSubclassOf<UPWGameplayAbility>& StartupAbility : DefaultAbilities)
		{
...
void APrototypeCharacter::OnRep_PlayerState()
{
	...
	{
		const FGameplayAbilityInputBinds Binds("Confirm", "Cancel", "EPWAbilityInputID", static_cast<int32>(EPWAbilityInputID::Confirm), static_cast<int32>(EPWAbilityInputID::Cancel));
